...
class Bulanan extends React.Component {
    render() {
        return (
            <ScrollView showsVerticalScrollIndicator={false}>
                <View style={{ paddingBottom: 20 }}>
                    ...
                    <View style={{ flexDirection: 'row', justifyContent: 'space-between', paddingTop: 20 }}>
                        <TouchableOpacity style={{ backgroundColor: '#ff9906', paddingVertical: 10, alignItems: 'center', borderRadius: 10, width: '45%' }}>
                            <Text style={{ fontSize: 15, fontFamily: 'BreeSerif-Regular', color: 'white', fontWeight: '400' }}>  Laporan{'\n'}Penjualan</Text>
                        </TouchableOpacity>
                        <TouchableOpacity style={{ backgroundColor: '#ff9906', paddingVertical: 10, borderRadius: 10, alignItems: 'center', width: '45%' }}>
                            <Text style={{ fontSize: 15, fontFamily: 'BreeSerif-Regular', color: 'white', fontWeight: '400' }}>  Laporan{'\n'}Pembelian</Text>
                        </TouchableOpacity>
                    </View>
                    <View style={{ flexDirection: 'row', justifyContent: 'space-between', paddingTop: 20 }}>
